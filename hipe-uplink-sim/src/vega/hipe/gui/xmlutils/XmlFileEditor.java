 ...
 *
 */
public class XmlFileEditor extends AbstractVariableEditorComponent<XmlDataInterface> {
	/**
	 * 
	 */
	...
	public void save(){
        try{
			...
			data.save();
					...
					JOptionPane.showMessageDialog(XmlFileEditor.this,
						    e1.getMessage(),
						    "Error",
	...
	public void saveAs(){
        try{
	          ...
	          int option = chooser.showSaveDialog(XmlFileEditor.this);
	          //File sf;
	...
	public void setData(XmlDataInterface data){
		this.data=data;
		init();
	}
	...
	public Icon getComponentIcon() {
        ...
        try {
            URL resource = XmlFileEditor.class.getResource(IconResources.XML_ICON);
	...
	@Override
	protected Class<? extends XmlData> getVariableType() {
