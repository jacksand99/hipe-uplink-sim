...
//package rosetta.uplink.commanding.gui;
...
public class ModelStateOutline extends CompositeDatasetOutline implements OutlineComponent{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	VariableSelection selection;
	CompositeDatasetOutline realOutline;
	public ModelStateOutline(){
		super();
	...
	public boolean init(Selection arg0, OutlineView arg1) {
		...
		while (it.hasNext()){
			...
			VS=new VariableSelection(key,((ModelState) obj).toString1d());
		}
