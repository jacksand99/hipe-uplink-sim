...
from vega.uplink.commanding import MappsModesOrcdMap
...
simulationContext.getModelState().setState("VR_H_Cover_Closed")
...
MappsModesOrcdMap.initStates(simulationContext)
